...
const MainScreen = () => {
    ...
    const handleMosquitoButtonPress = () => {
        ...
        setTimeout(() => {
            setShowMosquitoInfo(false) // 3초 후 숨기기
        }, 3000)
    }
        ...
        <View style={styles.container}>
            ...
            <Animated.View style={[styles.mapContainer, {height: mapHeight}]}>
                ...
                <View style={styles.statusBar}>
                    ...
                    {/* 모기지수수 */}
                    <View>
                        <TouchableOpacity onPress={() => handleMosquitoButtonPress()}>
                            <Image
                                source={require('@/assets/images/mosquitosIcon.png')}
            ...
            <View style={styles.listOuterContainer}>
                ...
                <View style={{backgroundColor: '#fff', paddingHorizontal: 16, paddingBottom: 10}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                        ...
                        <View style={{alignItems: 'center'}}>
                            <TouchableOpacity style={{alignItems:'center'}} onPress={() => setShowMarkers((prev: boolean) => !prev)}>
